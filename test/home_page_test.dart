...
void main() {
  group('Home Page ', () {
    testWidgets('should show all planets', (WidgetTester tester) async {
    ...
    testWidgets('should go to details page when tapping a planet', (WidgetTester tester) async {
      ...
      expect(find.text("Overview".toUpperCase()), findsOneWidget);
    });
  });
}